                    ...
                    <div class="row">
                        <div class="col-md-12 d-flex justify-content-between mb-3">
                            <div class="align-items-center justify-content-between">
                                <h1 class="h2 mb-0 text-white-800">CB2-203</h1>
                            </div>
    ...
    $(document).ready(function(){
        ...
        } else 
        {
            ...
            mondayTable = $('#mondayTable').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url':'includes/get_monday_data.php?room=CB2-203',
                    'type':'post',
                },
                'columnDefs': [{
            ...
            tuesdayTable = $('#tuesdayTable').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url':'includes/get_tuesday_data.php?room=CB2-203',
                    'type':'post',
                },
                'columnDefs': [{
                    className: 'hide_column',
            ...
            wednesdayTable = $('#wednesdayTable').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url':'includes/get_wednesday_data.php?room=CB2-203',
                    'type':'post',
                },
                'columnDefs': [{
                    className: 'hide_column',
            ...
            thursdayTable = $('#thursdayTable').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url':'includes/get_thursday_data.php?room=CB2-203',
                    'type':'post',
                },
                'columnDefs': [{
                    className: 'hide_column',
            ...
            fridayTable = $('#fridayTable').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url':'includes/get_friday_data.php?room=CB2-203',
                    'type':'post',
                },
                'columnDefs': [{
                    className: 'hide_column',
            ...
            saturdayTable = $('#saturdayTable').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url':'includes/get_saturday_data.php?room=CB2-203',
                    'type':'post',
                },
                'columnDefs': [{
                    className: 'hide_column',
            ...
            sundayTable = $('#sundayTable').DataTable({
                ...
                'ordering': false,
                'ajax': {
                    'url':'includes/get_sunday_data.php?room=CB2-203',
                    'type':'post',
                },
                'columnDefs': [{
                    className: 'hide_column',
